...
```bash
unzip fta-personal-study-app-v0.9-github-ready.zip
cd fta-personal-study-app-github-ready

git init
git add .
git commit -m "Add personal finance investment analyst study app v0.9"
git branch -M main
